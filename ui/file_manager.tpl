...
<div class="col">
  <div class="box-footer no-padding">
    <div class="mailbox-controls">
      <!-- Check all button -->
    <button type="button" class="btn btn-default btn-sm checkbox-toggle"><i class="fa fa-square"></i> Select all</button>
  <li class="btn-group">
    <button type="button" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button>
    <button type="button" class="btn btn-default btn-sm"><i class="fa fa-reply"></i></button>
    <button type="button" class="btn btn-default btn-sm"><i class="fa fa-share"></i></button>
    <button type="button" class="btn btn-default btn-sm" onclick="goBack()"><i class="fa fa-arrow-left"></i></button>
    <button type="button" class="btn btn-default btn-sm" onclick="goForward()"><i class="fa fa-arrow-right"></i></button>
</li>
      <!-- /.btn-group -->
      <button type="button" class="btn btn-default btn-sm refresh-button"><i class="fa fa-refresh"></i></button>
      <div class="pull-right">
        <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#upload"><i class="fa fa-upload"></i>
        Upload File
        </button>
      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#create-folder"><i class="fa fa-folder"></i> Create Folder</button>
      </div>
      <!-- /.pull-right -->
    </div>
  </div><br>
  ...
  {/if}
      ...
      <div class="box-tools pull-right">
        <div class="has-feedback">
          <input type="text" id="search-input" class="form-control input-sm" placeholder="Search Files">
    ...
    <div style="overflow-x:auto;" class="box-body no-padding">
      ...
      <tbody>
                  ...
                  <td>
                      <div class="file-actions">
                          {if $file['type'] neq 'Directory'}
                              <a href="{$_url}plugin/file_manager_download_file/&file={$directory}/{$index}&action=download&csrf_token={$csrfToken}" class="btn btn-default btn-xs"><i class="fa fa-download"></i></a>
                          {/if}
                          <a href="#" class="btn btn-default btn-xs"><i class="fa fa-eye"></i></a>
                          <a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#rename_{$index}"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-default btn-xs" onclick="confirmDeleteFolder('{$_url}plugin/file_manager_delete_folder/&action=delete_folder&directory={$directory}/{$file['filename']}&csrf_token={$csrfToken}')"><i class="fa fa-trash"></i></a>
                      </div>
                  </td>
              </tr>
              <!-- Rename Modal -->
              <div class="modal fade" id="rename_{$index}">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <form id="renameForm" method="POST" action="{$_url}plugin/file_manager_rename_files_folders">
                                  <div class="form-group">
                                      <label for="fileInput">Old Name:</label>
                                      <input type="text" name="oldName" class="form-control" placeholder="" value="{$file['filename']}" readonly>
                                      <label for="fileInput">New Name:</label>
                                      <input type="text" name="newName" class="form-control" placeholder="" value="{$file['filename']}" required>
                                      <input type="hidden" name="csrf_token" value="{$csrfToken}">
                                      <input type="hidden" name="dir" value="{$directory}/">
                                      <div class="modal-footer">
                                          <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
          ...
          <tr>
              ...
              <td>
                  <div class="file-actions">
                      <a href="{$_url}plugin/file_manager_download_file/&file={$directory}/{$file['filename']}&action=download&csrf_token={$csrfToken}" class="btn btn-default btn-xs"><i class="fa fa-download"></i></a>
                      <a href="#" class="btn btn-default btn-xs"><i class="fa fa-eye"></i></a>
                      <a href="#" class="btn btn-default btn-xs" data-toggle="modal" data-target="#renameModal_{$index}"><i class="fa fa-pencil"></i></a>
                      <a href="#" class="btn btn-default btn-xs" onclick="confirmDelete('{$_url}plugin/file_manager_delete_file/&file={$directory}/{$file['filename']}&action=delete&csrf_token={$csrfToken}')"><i class="fa fa-trash"></i></a>
                  </div>
              </td>
          </tr>
          <div class="modal fade" id="renameModal_{$index}">
              <div class="modal-dialog">
                  <div class="modal-content">
                      <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-labelledby="renameModalLabel_{$index}" aria-hidden="true">&times;</span>
                          </button>
                          <h4 class="modal-title">Rename: {$file['filename']}</h4>
                      </div>
                      <div class="modal-body">
        ...
        Full Size: <b> {$folderSize}</b> File: <b>{$fileCount}</b> Folder: <b>{$folderCount}</b>
          ...
          <div class="box-footer no-padding">
                <div class="mailbox-controls">
                  ...
                  <button type="button" class="btn btn-default btn-sm"><i class="fa fa-file-archive-o"></i> Tar</button>
                  <div class="pull-right">
